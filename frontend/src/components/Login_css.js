...
const Login_css = () => {
  return (
    <div className="bg-gray-100 flex h-screen">
      ...
      >
        <img
          alt="A picture of Earth with a hat and the word 'UNIQUEST' written in front"
          className="h-full w-full object-cover"
          src="https://storage.googleapis.com/a1aa/image/uvh0ZUJlSNKqDND2t8xvL8wIfjq86TXDztU3NrIuhvanKb1JA.jpg"
          width="600"
          height="800"
        />
      </div>
      ...
      <div className="fixed bottom-0 w-full bg-gray-800 text-white py-2 px-4 flex justify-between items-center">
        ...
        <div>
          <a className="text-xs text-blue-400 mr-4" href="#">
            Cookies Settings
          </a>
